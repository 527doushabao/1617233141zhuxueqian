...
>>> import urllib
>>> import urllib2
>>> values = {"username":"1016903103@qq.com","xxxx"}
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=C3E2CD2697A98757A211C25F8221A61F.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=C3E2CD2697A98757A211C25F8221A61F.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=C3E2CD2697A98757A211C25F8221A61F.tomcat1" />
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=C3E2CD2697A98757A211C25F8221A61F.tomcat1?from=http://my.csdn.net/my/mycsdn" method="post">
					...
					<input type="hidden" name="lt" value="LT-582970-6Q3CAuFD5QY5v4WDAMfc9LcEIKpfUP" />
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<script src="/js/apps/weixinqr.js;jsessionid=C3E2CD2697A98757A211C25F8221A61F.tomcat1"></script>
    ...
    <script data-main="/js/login-config.js;jsessionid=C3E2CD2697A98757A211C25F8221A61F.tomcat1" src="/js/libs/require.js;jsessionid=C3E2CD2697A98757A211C25F8221A61F.tomcat1"></script>
    <script type="text/javascript">
