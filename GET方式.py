...
>>> print response.gerur1

Traceback (most recent call last):
  File "<pyshell#10>", line 1, in <module>
    print response.gerur1
AttributeError: addinfourl instance has no attribute 'gerur1'
>>> print response.getur1()

Traceback (most recent call last):
  File "<pyshell#11>", line 1, in <module>
    print response.getur1()
AttributeError: addinfourl instance has no attribute 'getur1'
>>> print response.read()
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=50A6B5901F967D1731C2FFB8430FD069.tomcat2" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=50A6B5901F967D1731C2FFB8430FD069.tomcat2" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=50A6B5901F967D1731C2FFB8430FD069.tomcat2" />
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=50A6B5901F967D1731C2FFB8430FD069.tomcat2?from=http://my.csdn.net/my/mycsdn" method="post">
					...
					<input type="hidden" name="lt" value="LT-580257-vahLwhVfQrtbKl1VFTJ1eBjafmubqE" />
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<script src="/js/apps/weixinqr.js;jsessionid=50A6B5901F967D1731C2FFB8430FD069.tomcat2"></script>
    ...
    <script data-main="/js/login-config.js;jsessionid=50A6B5901F967D1731C2FFB8430FD069.tomcat2" src="/js/libs/require.js;jsessionid=50A6B5901F967D1731C2FFB8430FD069.tomcat2"></script>
    <script type="text/javascript">
